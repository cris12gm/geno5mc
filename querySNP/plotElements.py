...
def plotPromoters(inputDict):
    ...
    fig.update_layout(xaxis_tickangle=-45,xaxis_tickfont_size=12, xaxis_title='<b>CpGs associated in promoters</b>')
...
def plotEnhancers(inputDict):
    ...
    fig.update_layout(xaxis_tickangle=-45 ,xaxis_tickfont_size=12, xaxis_title='<b>CpGs associated in enhancers</b>')
...
def plotTrafficLights(inputDict):
    ...
    fig.update_layout(barmode='group', xaxis_tickangle=-45, xaxis_tickfont_size=12, xaxis_title='<b>CpGs associated that are also TLights</b>')
